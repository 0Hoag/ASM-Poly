...
public enum ErrorCode {
    ...
    PASSWORDS_DO_NOT_MATCH(1006, "PASSWORDS DO NOT MATCH", HttpStatus.BAD_REQUEST),
    USER_NOT_EXISTED(1006, "USER NOT EXISTED", HttpStatus.NOT_FOUND),
    USER_NOT_FOUND(1007, "USER NOT FOUND", HttpStatus.NOT_FOUND),  
    PHONE_VALID(1007, "INVALIDATE PHONE NUMBER", HttpStatus.NOT_FOUND),  
	...
	EMAIL_REQUIRED(1040, "EMAIL NOT VALID", HttpStatus.BAD_REQUEST),
	PHONE_REQUIRED(1041, "EMAIL NOT VALID", HttpStatus.BAD_REQUEST),
