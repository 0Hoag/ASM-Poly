        ...
        <div class="bg-white rounded shadow-sm p-4 p-md-5">
          ...
          <form @submit.prevent="handleLogin">
            <div class="mb-3">
              ...
              <input type="text" class="form-control py-2" id="email" v-model="email"
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                <input :type="passwordVisible ? 'text' : 'password'" class="form-control py-2" id="password"
...
const getAllCart = async () => {
  try {
    const response = await axios.get(`/api/v1/cart/List`);
