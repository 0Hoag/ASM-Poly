<template>
  ...
  >
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      <a href="order-management.html" class="btn btn-outline-secondary">
    ...
    <div class="card-body">
      <form>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            <div class="mb-3">
              <label for="shippingDistrict" class="form-label"
                >Quận/Huyện <span class="text-danger">*</span></label
              >
              <select class="form-select" id="shippingDistrict" required>
          ...
          <div class="col-md-4">
            <div class="mb-3">
              ...
              >
              <select class="form-select" id="shippingWard" required>
                  ...
                  <div class="col-md-3 mb-3">
                    <div class="card h-100">
                      ...
                      <div class="card-body">
                        ...
                        <button
                          type="button"
                          class="btn btn-primary w-100 add-product-btn"
                          data-product-id="1"
                          data-product-name="iPhone 14 Pro Max"
                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body">
                        ...
                        <button
                          ...
                          class="btn btn-primary w-100 add-product-btn"
                          data-product-id="2"
                          data-product-name="Samsung Galaxy S23 Ultra"
                          data-product-price="25990000"
                        >
                          Thêm
                        </button>
                      </div>
                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body">
                        ...
                        <button
                          ...
                          class="btn btn-primary w-100 add-product-btn"
                          data-product-id="3"
                          data-product-name="Xiaomi 13 Pro"
                          data-product-price="22990000"
                        >
                          Thêm
                        </button>
                      </div>
                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body">
                        ...
                        <button
                          ...
                          class="btn btn-primary w-100 add-product-btn"
                          data-product-id="4"
                          data-product-name="MacBook Pro 14"
                          data-product-price="45990000"
                        >
                          Thêm
                        </button>
                      </div>
