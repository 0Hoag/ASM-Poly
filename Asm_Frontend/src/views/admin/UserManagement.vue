...
const getPaginatedUser = async () => {
  try {
    const resp = await axios.get("/api/v1/user/Get", {
      params: {
        size: limit.value,
...
const addUser = async () => {
  try {
    ...
    const resp = await axios.post("/api/v1/user/", newUser);
...
const updateUser = async () => {
  try {
    ...
    const resp = await axios.put("/api/v1/user/" + updateUser.id, updateUser);
...
const search = async () => {
  try {
    ...
    const resp = await axios.get("/api/v1/user/search", {
      params: {
        size: limit.value,
        page: currentPage.value,
